    ...
    >
      ...
      >
        <h1 className="text-5xl sm:text-7xl font-bold max-w-lg sm:max-w-xl">
          Get a Second Brain with <span className="text-primary">crayonstech</span>
        </h1>
        <p className="text-base max-w-sm text-gray-500 mb-5 sm:mb-10">
        crayonstech is your second brain in the cloud, designed to easily store and
          retrieve unstructured information.
        </p>
        <Link href={"/login"}>
          <Button>Get Started</Button>
        </Link>
        <Link target="_blank" href={"https://github.com/ByteBallet/crayonstech/"}>
